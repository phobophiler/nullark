...
[Proving artifacts](/developers/proving-artifacts/) covers the Groth16 browser prover, artifact hashes, and public input order. [Runtime config](/developers/runtime-config/) covers chain, pool, verifier, fee, relayer endpoint label, and artifact fields. [Contracts](/reference/contracts/) lists public addresses. Raw proofs, calldata, deployment secrets, relayer credentials, funding records, and private evidence paths are outside this public reference.
