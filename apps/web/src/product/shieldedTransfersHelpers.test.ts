...
describe("sandbox testnet helpers", () => {
  ...
  it("encodes withdraw calldata with dynamic proof and public inputs", () => {
    ...
    expect(calldata).toContain("000000000000000000000000846646af497d1df2367f28666257c1a111aff1da");
  ...
  it("validates withdrawal public input bindings before wallet submission", () => {
    const publicInputs = [
      ...
      `0x${"01".repeat(32)}`,
      `0x${"02".repeat(32)}`,
      "0x000000000000000000000000846646af497d1df2367f28666257c1a111aff1da",
      `0x${"0".repeat(60)}2711`,
      `0x${"0".repeat(63)}a`,
      `0x${"0".repeat(60)}18c7`,
