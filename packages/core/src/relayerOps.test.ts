...
const record: RelayerOpsRecord = {
  ...
  relayers: [
    {
      ...
      custodyRef: "evidence/mainnet-readiness/v1-2/relayer-1-custody.md",
      maxHotWalletBalanceWei: "100000000000000000",
      fundingRunbookRef: "evidence/mainnet-readiness/v1-2/relayer-funding.md"
    }
  ],
  failoverRunbookRef: "evidence/mainnet-readiness/v1-2/relayer-failover.md",
  ...
  secretSafety: {
    ...
    rotationRunbookRef: "evidence/mainnet-readiness/v1-2/relayer-key-rotation.md"
  },
  deploymentBinding: {
    ...
    deploymentSelfTestArtifactRef: "evidence/mainnet-readiness/v1-2/relayer-deployment-self-test.json",
  ...
  incidentResponseRef: "evidence/mainnet-readiness/v1-2/incident-response.md",
  blockedUntil: []
};
...
describe("relayer ops readiness gate", () => {
  ...
  it("rejects draft evidence refs and unapproved owner approval refs", () => {
    expect(() =>
      assertRelayerOpsReady({
        ...record,
        ownerApprovalRef: "evidence/mainnet-readiness/v1-2/mainnet-owner-approval-message.md"
      })
    ).toThrow("relayer ops record owner approval ref must live under evidence/owner-approval");
    expect(() =>
      assertRelayerOpsReady({
        ...record,
        deploymentBinding: {
          ...record.deploymentBinding,
          deploymentSelfTestArtifactRef: "evidence/mainnet-readiness/v1-2/relayer-deployment-self-test.draft.json"
        }
      })
...
const v12RuntimePolicy: V12RelayerRuntimePolicyRecord = {
  ...
  evidenceRefs: [
    {
      ...
      path: "evidence/mainnet-readiness/v1-2/relayer-runtime-policy-final-evidence.json",
  ...
  monitoringEvidence: {
    monitoringRecordRef: "evidence/mainnet-readiness/v1-2/relayer-monitoring-evidence.approved.json",
    alertDestinationTestRef: "evidence/mainnet-readiness/v1-2/relayer-alert-destination-test.approved.json",
  ...
  staleFeeRejection: {
    status: "passed",
    evidenceRef: "evidence/mainnet-readiness/v1-2/relayer-stale-fee-rejection.approved.json",
    evidenceSha256: staleFeeEvidenceHash
  },
  pendingFeeBeforeActivationRejection: {
    status: "passed",
    evidenceRef: "evidence/mainnet-readiness/v1-2/relayer-preactivation-fee-rejection.approved.json",
    evidenceSha256: pendingFeeEvidenceHash
  },
  maxFeeAmountEnforced: {
    status: "passed",
    evidenceRef: "evidence/mainnet-readiness/v1-2/relayer-max-fee-amount-user-bound.approved.json",
    evidenceSha256: maxFeeEvidenceHash
  },
  minNetAmountEnforced: {
    status: "passed",
    evidenceRef: "evidence/mainnet-readiness/v1-2/relayer-min-net-amount-user-bound.approved.json",
    ...
    expect(() =>
      assertV12RelayerRuntimePolicyReady({
        ...
        staleFeeRejection: {
          ...
          evidenceRef: "evidence/mainnet-readiness/v1-2/relayer-runtime-policy-final-evidence.json"
        }
      })
