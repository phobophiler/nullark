...
const stageCMatrixEvidence = {
  requiredInputsRef: "evidence/mainnet-readiness/v1-2/gas/stage-c-mainnet-gas-log-storage-required-inputs.approved.json",
  variantEvidenceRef: "evidence/mainnet-readiness/v1-2/gas/stage-c-withdrawal-partial-change-variant.json",
  logSizeEvidenceRef: "evidence/mainnet-readiness/v1-2/gas/stage-c-withdrawal-log-size.json",
  indexerReplayRef: "evidence/mainnet-readiness/v1-2/gas/stage-c-indexer-replay.json",
  storageReviewRef: "evidence/mainnet-readiness/v1-2/gas/stage-c-withdrawal-storage-review.json",
  currentRootEvidenceRef: "evidence/mainnet-readiness/v1-2/gas/stage-c-withdrawal-current-root.json",
  volatileMetadataReviewRef: "evidence/mainnet-readiness/v1-2/gas/stage-c-volatile-metadata-review.json",
  txReceiptEvidenceRef: "evidence/mainnet-readiness/v1-2/gas/stage-c-withdrawal-tx-receipt.json",
  txLogsEvidenceRef: "evidence/mainnet-readiness/v1-2/gas/stage-c-withdrawal-tx-logs.json",
  selectorPathEvidenceRef: "evidence/mainnet-readiness/v1-2/gas/stage-c-withdrawal-selector-path.json",
  monitoringEvidenceRef: "evidence/mainnet-readiness/v1-2/relayer-monitoring/stage-c-withdrawal-monitoring.json"
} as const;
...
const record: MainnetGasEvidenceRecord = {
  ...
  deploymentPackageRef: "evidence/mainnet-readiness/v1-2/deployment-package.approved.json",
  sourceVerificationPackageRef: "evidence/mainnet-readiness/v1-2/source-verification-package.approved.json",
  trustedSetupRecordRef: "evidence/mainnet-readiness/v1-2/trusted-setup-verifier-promotion.approved.json",
  externalInputRefs: [
    "evidence/mainnet-readiness/v1-2/mainnet-required-inputs.md",
    "evidence/mainnet-readiness/v1-2/source-verification-package.approved.json",
    "evidence/mainnet-readiness/v1-2/trusted-setup-verifier-promotion.approved.json"
  ],
  ...
  entries: [
    ...operationEntries.map((operation, index): MainnetRemoteGasEntry => ({
      ...
      evidenceArtifactRef: `evidence/mainnet-readiness/v1-2/gas/${operation}.json`,
      inputArtifactRef: `evidence/mainnet-readiness/v1-2/gas/${operation}-input.json`,
      calldataHash: `sha256:${String(index + 1).repeat(64).slice(0, 64)}`,
      externalInputRefs: [
        "evidence/mainnet-readiness/v1-2/source-verification-package.approved.json",
        `evidence/mainnet-readiness/v1-2/gas/${operation}-input.json`
      ],
      ...
      ...(operation === "privateTransfer" || operation === "withdrawal" || operation === "stageCWithdrawal" || operation === "feeSweep"
        ? {
            ...
            stateReadinessRef: `evidence/mainnet-readiness/v1-2/gas/${operation}-state-readiness.json`
          }
        : {}),
    ...
    })),
    {
      ...
      evidenceArtifactRef: "evidence/mainnet-readiness/v1-2/gas/near-capacity-insertion-analysis.md",
      externalInputRefs: [
        "evidence/mainnet-readiness/v1-2/depth20-mainnet-benchmark-evidence.md",
        "evidence/mainnet-readiness/v1-2/mainnet-pool-architecture.approved.json"
      ],
      blockNumber: 150,
      target: pool,
      merkleTreeDepth: 20,
    ...
    } satisfies MainnetCapacityAnalysisEntry,
    {
      ...
      evidenceArtifactRef: "evidence/mainnet-readiness/v1-2/gas/volatile-block-metadata-review.md",
      externalInputRefs: ["evidence/mainnet-readiness/v1-2/contract-review-mainnet-readiness.md"],
      blockNumber: 200,
      target: pool,
      ...
      volatileMetadataPaths: [
        ...
        },
        {
          ...
          computeLimitEvidenceRef: "public-artifacts/evidence/mainnet-readiness/gas/stage-c-deadline-volatile-compute-limit.json"
        }
      ],
...
describe("mainnet gas evidence readiness gate", () => {
  ...
  it("keeps real-state blockers explicit and rejects fake state-dependent estimates", () => {
    const blockedPrivateTransfer = {
      ...
      evidenceArtifactRef: "evidence/mainnet-readiness/v1-2/gas/private-transfer-state-blocker.md",
      externalInputRefs: ["evidence/mainnet-readiness/v1-2/mainnet-required-inputs.md"],
      blockNumber: 120,
      target: pool,
  ...
  it("requires mainnet gas evidence refs to bind expected packages", () => {
    expect(() =>
      assertMainnetGasEvidenceReady({
        ...record,
        ownerApprovalRef: "evidence/mainnet-readiness/v1-2/mainnet-gas-evidence.md"
      })
    ).toThrow("mainnet gas evidence owner approval ref must live under evidence/owner-approval");
    ...
    expect(() =>
      assertMainnetGasEvidenceReady({
        ...record,
        sourceVerificationPackageRef: "evidence/mainnet-readiness/v1-2/security-review.approved.json"
      })
    ...
    expect(() =>
      assertMainnetGasEvidenceReady({
        ...record,
        deploymentPackageRef: "evidence/mainnet-readiness/v1-2/nullark-v1-1-release-candidate-deployment-package.json"
      })
    ...
    expect(() =>
      assertMainnetGasEvidenceReady({
        ...record,
        sourceVerificationPackageRef: "evidence/mainnet-readiness/v1-2/source-verification-package.draft.json"
      })
    ).toThrow(
  ...
  it("requires Stage C state blockers to name current-runtime receipt, log, storage, selector, and redaction gates", () => {
    const stageCBlocked = {
      ...
      rpcUrl: "https://mainnet.megaeth.com/rpc",
      evidenceKind: "state-blocked",
      evidenceArtifactRef: "evidence/mainnet-readiness/v1-2/gas/stage-c-current-runtime-blocker.md",
      externalInputRefs: ["evidence/mainnet-readiness/v1-2/gas/stage-c-mainnet-gas-log-storage-required-inputs.json"],
      blockNumber: 180,
      target: pool,
...
function v12RemoteEstimateOperation(operation: V12FeeGovernanceGasOperationName): V12FeeGovernanceRemoteEstimateOperation {
  return {
    ...
    evidenceRef: `evidence/mainnet-readiness/v1-2/fee-governance-gas-log-storage-${operation}.json`,
    ...
    statePreconditionsRef: `evidence/mainnet-readiness/v1-2/fee-governance-state-preconditions-${operation}.json`,
      ...
      assertV12FeeGovernanceGasEvidenceReady({
        ...
        operations: {
          ...
          feeSweep: {
            ...
            txHash: undefined,
            broadcastApprovalRef: "evidence/mainnet-readiness/v1-2/broadcast-approval.json",
      ...
      assertV12FeeGovernanceGasEvidenceReady({
        ...
        operations: {
          ...
          feeSweep: {
            ...
            ownerAcceptedSubstituteRef: "evidence/mainnet-readiness/v1-2/fee-governance-owner-substitute.json",
      ...
      assertV12FeeGovernanceGasEvidenceReady({
        ...
        operations: {
          ...
          feeSweep: {
            ...estimateRecord.operations.feeSweep,
            evidenceKind: "owner-accepted-substitute",
            ownerAcceptedSubstituteRef: "evidence/mainnet-readiness/v1-2/draft-fee-governance-owner-substitute.json",
            ownerAcceptedSubstituteSha256: "sha256:9999999999999999999999999999999999999999999999999999999999999999",
