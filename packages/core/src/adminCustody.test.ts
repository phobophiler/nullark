...
const record: AdminCustodyRecord = {
  ...
  roles: {
    feeController: {
      ...
      custodyRef: "evidence/mainnet-readiness/v1-2/fee-controller-custody.md",
      executionPolicyRef: "evidence/mainnet-readiness/v1-2/fee-controller-execution-policy.md",
      multisigConfigArtifactRef: "evidence/mainnet-readiness/v1-2/fee-controller-safe-config.json",
      multisigConfigHash: `sha256:${"1".repeat(64)}`,
      deploymentEvidenceRef: "evidence/mainnet-readiness/v1-2/deployment-receipts/fee-controller-safe.json",
      deploymentEvidenceHash: `sha256:${"4".repeat(64)}`
    }
  },
  roleSeparationApproved: true,
  roleSeparationEvidenceRef: "evidence/mainnet-readiness/v1-2/admin-role-separation.json",
  roleSeparationEvidenceHash: `sha256:${"3".repeat(64)}`,
  keyCompromiseRunbookRef: "evidence/mainnet-readiness/v1-2/admin-key-compromise-runbook.md",
  lostKeyRunbookRef: "evidence/mainnet-readiness/v1-2/admin-lost-key-runbook.md",
...
describe("admin custody readiness gate", () => {
      ...
      assertAdminCustodyReady({
        ...
        roles: {
          ...
          emergencyGuardian: {
            ...
            custodyRef: "evidence/mainnet-readiness/v1-2/emergency-guardian-custody.md",
            executionPolicyRef: "evidence/mainnet-readiness/v1-2/emergency-guardian-execution-policy.md",
            multisigConfigArtifactRef: "evidence/mainnet-readiness/v1-2/emergency-guardian-safe-config.json",
            multisigConfigHash: `sha256:${"2".repeat(64)}`,
            deploymentEvidenceRef: "evidence/mainnet-readiness/v1-2/deployment-receipts/emergency-guardian-safe.json",
  ...
  it("requires custody evidence to bind the mainnet deployment package", () => {
    expect(() =>
      assertAdminCustodyReady({
        ...record,
        deploymentPackageRef: "evidence/mainnet-readiness/v1-2/admin-custody-record.approved.json"
      })
  ...
  evidenceRefs: [
    {
      ...
      path: "evidence/mainnet-readiness/v1-2/fee-controller-safe-config.json",
      sha256: "b".repeat(64)
    },
    {
      label: "fee-controller-owner-roster-review",
      path: "evidence/mainnet-readiness/v1-2/fee-controller-owner-roster-review.json",
      sha256: "c".repeat(64)
    }
  ],
  safe: {
