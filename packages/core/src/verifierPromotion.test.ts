...
const v12Artifact = (name: string, hashValue = hash) => ({
  path: `evidence/mainnet-readiness/v1-2/artifacts/${name}.json`,
  sha256: hashValue
});
...
const v12ReviewGate = (referenceName: string) => ({
  ...
  reference: `evidence/mainnet-readiness/v1-2/reviews/${referenceName}.md`,
...
const v12TrustedSetupProverPromotionRecord: V12TrustedSetupProverPromotionRecord = {
  ...
  ownerApprovalRef: "evidence/mainnet-readiness/v1-2/owner-approval/trusted-setup-prover-promotion.md",
  ...
  evidenceRefs: [
    {
      ...
      path: "evidence/mainnet-readiness/v1-2/final-trusted-setup-prover-promotion.json",
      sha256: hash
    }
  ],
...
describe("Nullark v1.2 trusted setup/prover promotion gate", () => {
        ...
        evidenceRefs: [
          {
            ...
            path: "evidence/mainnet-readiness/v1-2/template-trusted-setup-evidence.json"
          }
        ]
      })
  ...
  it("requires compatibility proof hashes to match the declared v1.2 artifacts and public-input hash", () => {
    const completeProof = {
      status: "complete",
      reference: "evidence/mainnet-readiness/v1-2/compatibility/prover-artifacts.md",
      sha256: hash,
      publicInputOrderHash,
