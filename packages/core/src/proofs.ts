...
export const PROOF_CONTEXT_V1_SHAPE_WITHDRAW = hashDomainSeparator("withdraw_context_v1_1");
export const PROOF_CONTEXT_V1_SHAPE_PRIVATE_TRANSFER = hashDomainSeparator("private_transfer_context_v1_1");
