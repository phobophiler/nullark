...
describe("sdk Poseidon note derivation", () => {
  it("matches the app and circuit note commitment formula", async () => {
    await expect(
  ...
  it("matches the app and circuit nullifier formula with chain and pool binding", async () => {
    ...
    const differentChain = await deriveNullifier({
      noteSecret: deterministicField,
      leafIndex: 7,
      chainId: 1,
      verifyingContract: "0xa87F70bdaBa7A8be894AC60D111FF79Ec8b0d544"
