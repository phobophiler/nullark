...
const V12_TESTNET_POOL = "0xEc61D863700DeF260E7BABA634FAa24AEC81f29e" as const;
...
const V12_TESTNET_TRUSTED_SETUP_RECORD_HASH =
  "0x7cf2ba6c7d482179a5a246ad4fa0ab7c4bbebb6a48108d0fe0963b8a364c825e" as const;
const V12_INDEXER_READINESS_BINDINGS = [
  {
  ...
  },
  {
    ...
    chainId: 6343,
    pool: V12_TESTNET_POOL,
    approvedEvidenceHashes: [V12_TESTNET_TRUSTED_SETUP_RECORD_HASH]
  }
] as const;
...
function hasMatchingV12IndexerReadinessEvidence(
  ...
  const binding = V12_INDEXER_READINESS_BINDINGS.find(
    (candidate) =>
      candidate.runtimeId === evidence.runtimeId &&
      candidate.chainId === chainId &&
      candidate.pool.toLowerCase() === pool.toLowerCase()
  );
  return (
    binding !== undefined &&
