...
contract DeployMegaEthMainnetFullStack is MegaEthMainnetDeploymentGuards {
        ...
        )
    {
        ...
        _requirePromotedVerifierSourceApproval();
        ...
        _requireMainnetPoolRoleConfig(address(verifierAdapter), feeController);
